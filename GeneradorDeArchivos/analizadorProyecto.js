...
function peg$parse(input, options) {
  ...
  var peg$e46 = peg$literalExpectation("for", false);
  ...
  var peg$f9 = function(id, asig) { return crearNodo('AsignacionValor',{id,asig})};
  var peg$f10 = function(id, op, sum) { return crearNodo('ModIgualacion',{id,op,sum})};
  ...
  var peg$f21 = function(num) { return crearNodo('Unaria', { op: '-', exp: num }) };
  var peg$f22 = function(num) { return crearNodo('Negacion', { op: '-', exp: num }) };
  var peg$f23 = function(exp) { return crearNodo('Agrupacion', { exp }) };
  var peg$f24 = function(id) { return crearNodo('ReferenciaVariable', { id }) };
  var peg$f25 = function() {return crearNodo('TerminalesExp', { tipo:"Float",valor: parseFloat(text(), 10) })};
  var peg$f26 = function() {return crearNodo('TerminalesExp', {tipo:"Entero" ,valor: parseFloat(text(), 10) })};
  var peg$f27 = function() {return crearNodo('TerminalesExp',{tipo:"Boolean",valor:"true"})};
  var peg$f28 = function() {return crearNodo('TerminalesExp',{tipo:"Boolean",valor:"false"})};
  var peg$f29 = function(chars) { return crearNodo('TerminalesExpCadena', {tipo:"String", valor:chars}) };
  var peg$f30 = function(es) { return es};
  ...
  var peg$f37 = function(char) { return crearNodo('TerminalesExp',{tipo:"Char",valor:char}) };
  var peg$f38 = function(es) { return es};
  var peg$f39 = function() {return text()};
  var peg$f40 = function() { return text() };
  var peg$f41 = function() { return "int"; };
  var peg$f42 = function() { return "float"; };
  var peg$f43 = function() { return "string"; };
  var peg$f44 = function() { return "boolean"; };
  var peg$f45 = function() { return "char"; };
  var peg$f46 = function() { return "var"};
