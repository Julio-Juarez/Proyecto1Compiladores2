...
function peg$parse(input, options) {
  ...
  var peg$f2 = function(tipo, id, exp) {return crearNodo('DeclaracionVariable',{tipo,id,exp})};
  var peg$f3 = function(tipo, id) {return crearNodo('DeclaracionVariableSinValor',{tipo,id})};
  var peg$f4 = function() {return crearNodo('numero', { valor: parseFloat(text(), 10) })};
  var peg$f5 = function(id, asig) { return crearNodo('AsignacionValor',{id,asig})};
  var peg$f6 = function() { return text() };
  var peg$f7 = function() { return "int"; };
  var peg$f8 = function() { return "float"; };
  var peg$f9 = function() { return "string"; };
  var peg$f10 = function() { return "boolean"; };
  var peg$f11 = function() { return "char"; };
